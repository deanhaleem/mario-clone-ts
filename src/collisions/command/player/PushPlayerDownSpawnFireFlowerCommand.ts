...
export class PushPlayerDownSpawnFireFlowerCommand extends Command<PlayerBlockCollisionHandler> {
  ...
  public override execute(): void {
    this.receiver.handleBottomNonSmallPlayerPowerUpBlockCollision();
  }
}
